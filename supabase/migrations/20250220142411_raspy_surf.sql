/*
  ...
  1. New Tables
    - `mock_transactions`: Stores payment transaction records
    - `mock_payment_methods`: Stores test payment methods
    - `mock_webhooks`: Stores simulated webhook events

  2. Functions
    - `process_mock_payment`: Simulates payment processing with test cards
    - `create_mock_payment_method`: Creates test payment methods
    - `simulate_webhook_event`: Generates mock webhook events
