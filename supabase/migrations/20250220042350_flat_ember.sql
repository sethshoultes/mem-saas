/*
  ...
  1. Schema Updates
    ...
    - Added trial_ends_at to member_subscriptions
    - Added trial_status tracking

  2. New Functions
    - create_trial_subscription: Creates subscriptions with trial periods
    - process_trial_expiration: Handles trial to paid conversion
    - get_trial_status: Retrieves trial information

  3. Changes
    - Enhanced subscription creation to support trials
    - Added trial period validation
    - Added trial expiration handling
*/
...
BEGIN
  ...
  SELECT s.*, p.trial_days INTO v_subscription, v_trial_days
